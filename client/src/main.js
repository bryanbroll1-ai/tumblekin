import { BoardGame } from "./game/BoardGame.js?v=tumblekin114";
import { ClientNetwork } from "./network/ClientNetwork.js?v=tumblekin114";
import { UIManager } from "./ui/UIManager.js?v=tumblekin114";
import { BounceArena } from "./minigames/BounceArena.js?v=tumblekin114";
import { RunnerDerby } from "./minigames/RunnerDerby.js?v=tumblekin114";
import { ColorRush } from "./minigames/ColorRush.js?v=tumblekin114";
import { Nervenprobe } from "./minigames/Nervenprobe.js?v=tumblekin114";
import { RedLightGate } from "./minigames/RedLightGate.js?v=tumblekin114";
import { BalloonPump } from "./minigames/BalloonPump.js?v=tumblekin114";
import { BarrelRoll } from "./minigames/BarrelRoll.js?v=tumblekin114";
import { BombPass } from "./minigames/BombPass.js?v=tumblekin114";
import { CoinRain } from "./minigames/CoinRain.js?v=tumblekin114";
import { WhackBlob } from "./minigames/WhackBlob.js?v=tumblekin114";
import { RopeSkip } from "./minigames/RopeSkip.js?v=tumblekin114";
import { CannonFly } from "./minigames/CannonFly.js?v=tumblekin114";
import { KnifeThrow } from "./minigames/KnifeThrow.js?v=tumblekin114";
import { TowerStack } from "./minigames/TowerStack.js?v=tumblekin114";
import { CliffClimb } from "./minigames/CliffClimb.js?v=tumblekin114";
import { BalloonGlide } from "./minigames/BalloonGlide.js?v=tumblekin114";
import { SumoPush } from "./minigames/SumoPush.js?v=tumblekin114";
import { Trampoline } from "./minigames/Trampoline.js?v=tumblekin114";
import { FalseSignal } from "./minigames/FalseSignal.js?v=tumblekin114";
import { TracePainter } from "./minigames/TracePainter.js?v=tumblekin114";
import { SortBelt } from "./minigames/SortBelt.js?v=tumblekin114";
import { SeekGrid } from "./minigames/SeekGrid.js?v=tumblekin114";
import { SwarmCount } from "./minigames/SwarmCount.js?v=tumblekin114";
import { LightSequence } from "./minigames/LightSequence.js?v=tumblekin114";
import { FlashReflex } from "./minigames/FlashReflex.js?v=tumblekin114";
import { PegBoard } from "./minigames/PegBoard.js?v=tumblekin114";
import { IceStock } from "./minigames/IceStock.js?v=tumblekin114";
import { DeepDig } from "./minigames/DeepDig.js?v=tumblekin114";
import { FishDuel } from "./minigames/FishDuel.js?v=tumblekin114";
import { ColorHunt } from "./minigames/ColorHunt.js?v=tumblekin114";
import { Feedback } from "./game/Feedback.js?v=tumblekin114";
