import { BoardGame } from "./game/BoardGame.js?v=tumblekin126";
import { ClientNetwork } from "./network/ClientNetwork.js?v=tumblekin126";
import { UIManager } from "./ui/UIManager.js?v=tumblekin126";
import { BounceArena } from "./minigames/BounceArena.js?v=tumblekin126";
import { RunnerDerby } from "./minigames/RunnerDerby.js?v=tumblekin126";
import { ColorRush } from "./minigames/ColorRush.js?v=tumblekin126";
import { Nervenprobe } from "./minigames/Nervenprobe.js?v=tumblekin126";
import { RedLightGate } from "./minigames/RedLightGate.js?v=tumblekin126";
import { BalloonPump } from "./minigames/BalloonPump.js?v=tumblekin126";
import { BarrelDare } from "./minigames/BarrelDare.js?v=tumblekin126";
import { BarrelRoll } from "./minigames/BarrelRoll.js?v=tumblekin126";
import { BombPass } from "./minigames/BombPass.js?v=tumblekin126";
import { CoinRain } from "./minigames/CoinRain.js?v=tumblekin126";
import { WhackBlob } from "./minigames/WhackBlob.js?v=tumblekin126";
import { RopeSkip } from "./minigames/RopeSkip.js?v=tumblekin126";
import { CannonFly } from "./minigames/CannonFly.js?v=tumblekin126";
import { KnifeThrow } from "./minigames/KnifeThrow.js?v=tumblekin126";
import { TowerStack } from "./minigames/TowerStack.js?v=tumblekin126";
import { CliffClimb } from "./minigames/CliffClimb.js?v=tumblekin126";
import { BalloonGlide } from "./minigames/BalloonGlide.js?v=tumblekin126";
import { SumoPush } from "./minigames/SumoPush.js?v=tumblekin126";
import { Trampoline } from "./minigames/Trampoline.js?v=tumblekin126";
import { FalseSignal } from "./minigames/FalseSignal.js?v=tumblekin126";
import { TracePainter } from "./minigames/TracePainter.js?v=tumblekin126";
import { SortBelt } from "./minigames/SortBelt.js?v=tumblekin126";
import { SeekGrid } from "./minigames/SeekGrid.js?v=tumblekin126";
import { SwarmCount } from "./minigames/SwarmCount.js?v=tumblekin126";
import { LightSequence } from "./minigames/LightSequence.js?v=tumblekin126";
import { FlashReflex } from "./minigames/FlashReflex.js?v=tumblekin126";
import { PegBoard } from "./minigames/PegBoard.js?v=tumblekin126";
import { IceStock } from "./minigames/IceStock.js?v=tumblekin126";
import { DeepDig } from "./minigames/DeepDig.js?v=tumblekin126";
import { FishDuel } from "./minigames/FishDuel.js?v=tumblekin126";
import { ColorHunt } from "./minigames/ColorHunt.js?v=tumblekin126";
import { Feedback } from "./game/Feedback.js?v=tumblekin126";
