import { BoardGame } from "./game/BoardGame.js?v=tumblekin100";
import { ClientNetwork } from "./network/ClientNetwork.js?v=tumblekin100";
import { UIManager } from "./ui/UIManager.js?v=tumblekin100";
import { BounceArena } from "./minigames/BounceArena.js?v=tumblekin100";
import { RunnerDerby } from "./minigames/RunnerDerby.js?v=tumblekin100";
import { ColorRush } from "./minigames/ColorRush.js?v=tumblekin100";
import { Nervenprobe } from "./minigames/Nervenprobe.js?v=tumblekin100";
import { RedLightGate } from "./minigames/RedLightGate.js?v=tumblekin100";
import { BalloonPump } from "./minigames/BalloonPump.js?v=tumblekin100";
import { BarrelRoll } from "./minigames/BarrelRoll.js?v=tumblekin100";
import { BombPass } from "./minigames/BombPass.js?v=tumblekin100";
import { CoinRain } from "./minigames/CoinRain.js?v=tumblekin100";
import { WhackBlob } from "./minigames/WhackBlob.js?v=tumblekin100";
import { RopeSkip } from "./minigames/RopeSkip.js?v=tumblekin100";
import { CannonFly } from "./minigames/CannonFly.js?v=tumblekin100";
import { KnifeThrow } from "./minigames/KnifeThrow.js?v=tumblekin100";
import { TowerStack } from "./minigames/TowerStack.js?v=tumblekin100";
import { CliffClimb } from "./minigames/CliffClimb.js?v=tumblekin100";
import { BalloonGlide } from "./minigames/BalloonGlide.js?v=tumblekin100";
import { SumoPush } from "./minigames/SumoPush.js?v=tumblekin100";
import { Trampoline } from "./minigames/Trampoline.js?v=tumblekin100";
import { FalseSignal } from "./minigames/FalseSignal.js?v=tumblekin100";
import { TracePainter } from "./minigames/TracePainter.js?v=tumblekin100";
import { SortBelt } from "./minigames/SortBelt.js?v=tumblekin100";
import { SeekGrid } from "./minigames/SeekGrid.js?v=tumblekin100";
import { SwarmCount } from "./minigames/SwarmCount.js?v=tumblekin100";
import { LightSequence } from "./minigames/LightSequence.js?v=tumblekin100";
import { FlashReflex } from "./minigames/FlashReflex.js?v=tumblekin100";
import { PegBoard } from "./minigames/PegBoard.js?v=tumblekin100";
import { IceStock } from "./minigames/IceStock.js?v=tumblekin100";
import { DeepDig } from "./minigames/DeepDig.js?v=tumblekin100";
import { FishDuel } from "./minigames/FishDuel.js?v=tumblekin100";
import { ColorHunt } from "./minigames/ColorHunt.js?v=tumblekin100";
import { Feedback } from "./game/Feedback.js?v=tumblekin100";
