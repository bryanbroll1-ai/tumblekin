import { BoardGame } from "./game/BoardGame.js?v=tumblekin64";
import { ClientNetwork } from "./network/ClientNetwork.js?v=tumblekin64";
import { UIManager } from "./ui/UIManager.js?v=tumblekin64";
import { BounceArena } from "./minigames/BounceArena.js?v=tumblekin64";
import { RunnerDerby } from "./minigames/RunnerDerby.js?v=tumblekin64";
import { ColorRush } from "./minigames/ColorRush.js?v=tumblekin64";
import { Nervenprobe } from "./minigames/Nervenprobe.js?v=tumblekin64";
import { RedLightGate } from "./minigames/RedLightGate.js?v=tumblekin64";
import { BalloonPump } from "./minigames/BalloonPump.js?v=tumblekin64";
import { BarrelRoll } from "./minigames/BarrelRoll.js?v=tumblekin64";
import { BombPass } from "./minigames/BombPass.js?v=tumblekin64";
import { CoinRain } from "./minigames/CoinRain.js?v=tumblekin64";
import { WhackBlob } from "./minigames/WhackBlob.js?v=tumblekin64";
import { RopeSkip } from "./minigames/RopeSkip.js?v=tumblekin64";
import { CannonFly } from "./minigames/CannonFly.js?v=tumblekin64";
import { KnifeThrow } from "./minigames/KnifeThrow.js?v=tumblekin64";
import { TowerStack } from "./minigames/TowerStack.js?v=tumblekin64";
import { CliffClimb } from "./minigames/CliffClimb.js?v=tumblekin64";
import { Feedback } from "./game/Feedback.js?v=tumblekin64";
