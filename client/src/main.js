import { BoardGame } from "./game/BoardGame.js?v=tumblekin63";
import { ClientNetwork } from "./network/ClientNetwork.js?v=tumblekin63";
import { UIManager } from "./ui/UIManager.js?v=tumblekin63";
import { BounceArena } from "./minigames/BounceArena.js?v=tumblekin63";
import { RunnerDerby } from "./minigames/RunnerDerby.js?v=tumblekin63";
import { ColorRush } from "./minigames/ColorRush.js?v=tumblekin63";
import { Nervenprobe } from "./minigames/Nervenprobe.js?v=tumblekin63";
import { RedLightGate } from "./minigames/RedLightGate.js?v=tumblekin63";
import { BalloonPump } from "./minigames/BalloonPump.js?v=tumblekin63";
import { BarrelRoll } from "./minigames/BarrelRoll.js?v=tumblekin63";
import { BombPass } from "./minigames/BombPass.js?v=tumblekin63";
import { CoinRain } from "./minigames/CoinRain.js?v=tumblekin63";
import { WhackBlob } from "./minigames/WhackBlob.js?v=tumblekin63";
import { RopeSkip } from "./minigames/RopeSkip.js?v=tumblekin63";
import { CannonFly } from "./minigames/CannonFly.js?v=tumblekin63";
import { KnifeThrow } from "./minigames/KnifeThrow.js?v=tumblekin63";
import { TowerStack } from "./minigames/TowerStack.js?v=tumblekin63";
import { CliffClimb } from "./minigames/CliffClimb.js?v=tumblekin63";
import { Feedback } from "./game/Feedback.js?v=tumblekin63";
