import { BoardGame } from "./game/BoardGame.js?v=tumblekin87";
import { ClientNetwork } from "./network/ClientNetwork.js?v=tumblekin87";
import { UIManager } from "./ui/UIManager.js?v=tumblekin87";
import { BounceArena } from "./minigames/BounceArena.js?v=tumblekin87";
import { RunnerDerby } from "./minigames/RunnerDerby.js?v=tumblekin87";
import { ColorRush } from "./minigames/ColorRush.js?v=tumblekin87";
import { Nervenprobe } from "./minigames/Nervenprobe.js?v=tumblekin87";
import { RedLightGate } from "./minigames/RedLightGate.js?v=tumblekin87";
import { BalloonPump } from "./minigames/BalloonPump.js?v=tumblekin87";
import { BarrelRoll } from "./minigames/BarrelRoll.js?v=tumblekin87";
import { BombPass } from "./minigames/BombPass.js?v=tumblekin87";
import { CoinRain } from "./minigames/CoinRain.js?v=tumblekin87";
import { WhackBlob } from "./minigames/WhackBlob.js?v=tumblekin87";
import { RopeSkip } from "./minigames/RopeSkip.js?v=tumblekin87";
import { CannonFly } from "./minigames/CannonFly.js?v=tumblekin87";
import { KnifeThrow } from "./minigames/KnifeThrow.js?v=tumblekin87";
import { TowerStack } from "./minigames/TowerStack.js?v=tumblekin87";
import { CliffClimb } from "./minigames/CliffClimb.js?v=tumblekin87";
import { BalloonGlide } from "./minigames/BalloonGlide.js?v=tumblekin87";
import { SumoPush } from "./minigames/SumoPush.js?v=tumblekin87";
import { Trampoline } from "./minigames/Trampoline.js?v=tumblekin87";
import { FalseSignal } from "./minigames/FalseSignal.js?v=tumblekin87";
import { TracePainter } from "./minigames/TracePainter.js?v=tumblekin87";
import { SortBelt } from "./minigames/SortBelt.js?v=tumblekin87";
import { LightSequence } from "./minigames/LightSequence.js?v=tumblekin87";
import { FlashReflex } from "./minigames/FlashReflex.js?v=tumblekin87";
import { PegBoard } from "./minigames/PegBoard.js?v=tumblekin87";
import { IceStock } from "./minigames/IceStock.js?v=tumblekin87";
import { DeepDig } from "./minigames/DeepDig.js?v=tumblekin87";
import { FishDuel } from "./minigames/FishDuel.js?v=tumblekin87";
import { ColorHunt } from "./minigames/ColorHunt.js?v=tumblekin87";
import { Feedback } from "./game/Feedback.js?v=tumblekin87";
