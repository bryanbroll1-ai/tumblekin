import { BoardGame } from "./game/BoardGame.js?v=tumblekin112";
import { ClientNetwork } from "./network/ClientNetwork.js?v=tumblekin112";
import { UIManager } from "./ui/UIManager.js?v=tumblekin112";
import { BounceArena } from "./minigames/BounceArena.js?v=tumblekin112";
import { RunnerDerby } from "./minigames/RunnerDerby.js?v=tumblekin112";
import { ColorRush } from "./minigames/ColorRush.js?v=tumblekin112";
import { Nervenprobe } from "./minigames/Nervenprobe.js?v=tumblekin112";
import { RedLightGate } from "./minigames/RedLightGate.js?v=tumblekin112";
import { BalloonPump } from "./minigames/BalloonPump.js?v=tumblekin112";
import { BarrelRoll } from "./minigames/BarrelRoll.js?v=tumblekin112";
import { BombPass } from "./minigames/BombPass.js?v=tumblekin112";
import { CoinRain } from "./minigames/CoinRain.js?v=tumblekin112";
import { WhackBlob } from "./minigames/WhackBlob.js?v=tumblekin112";
import { RopeSkip } from "./minigames/RopeSkip.js?v=tumblekin112";
import { CannonFly } from "./minigames/CannonFly.js?v=tumblekin112";
import { KnifeThrow } from "./minigames/KnifeThrow.js?v=tumblekin112";
import { TowerStack } from "./minigames/TowerStack.js?v=tumblekin112";
import { CliffClimb } from "./minigames/CliffClimb.js?v=tumblekin112";
import { BalloonGlide } from "./minigames/BalloonGlide.js?v=tumblekin112";
import { SumoPush } from "./minigames/SumoPush.js?v=tumblekin112";
import { Trampoline } from "./minigames/Trampoline.js?v=tumblekin112";
import { FalseSignal } from "./minigames/FalseSignal.js?v=tumblekin112";
import { TracePainter } from "./minigames/TracePainter.js?v=tumblekin112";
import { SortBelt } from "./minigames/SortBelt.js?v=tumblekin112";
import { SeekGrid } from "./minigames/SeekGrid.js?v=tumblekin112";
import { SwarmCount } from "./minigames/SwarmCount.js?v=tumblekin112";
import { LightSequence } from "./minigames/LightSequence.js?v=tumblekin112";
import { FlashReflex } from "./minigames/FlashReflex.js?v=tumblekin112";
import { PegBoard } from "./minigames/PegBoard.js?v=tumblekin112";
import { IceStock } from "./minigames/IceStock.js?v=tumblekin112";
import { DeepDig } from "./minigames/DeepDig.js?v=tumblekin112";
import { FishDuel } from "./minigames/FishDuel.js?v=tumblekin112";
import { ColorHunt } from "./minigames/ColorHunt.js?v=tumblekin112";
import { Feedback } from "./game/Feedback.js?v=tumblekin112";
