import { BoardGame } from "./game/BoardGame.js?v=tumblekin89";
import { ClientNetwork } from "./network/ClientNetwork.js?v=tumblekin89";
import { UIManager } from "./ui/UIManager.js?v=tumblekin89";
import { BounceArena } from "./minigames/BounceArena.js?v=tumblekin89";
import { RunnerDerby } from "./minigames/RunnerDerby.js?v=tumblekin89";
import { ColorRush } from "./minigames/ColorRush.js?v=tumblekin89";
import { Nervenprobe } from "./minigames/Nervenprobe.js?v=tumblekin89";
import { RedLightGate } from "./minigames/RedLightGate.js?v=tumblekin89";
import { BalloonPump } from "./minigames/BalloonPump.js?v=tumblekin89";
import { BarrelRoll } from "./minigames/BarrelRoll.js?v=tumblekin89";
import { BombPass } from "./minigames/BombPass.js?v=tumblekin89";
import { CoinRain } from "./minigames/CoinRain.js?v=tumblekin89";
import { WhackBlob } from "./minigames/WhackBlob.js?v=tumblekin89";
import { RopeSkip } from "./minigames/RopeSkip.js?v=tumblekin89";
import { CannonFly } from "./minigames/CannonFly.js?v=tumblekin89";
import { KnifeThrow } from "./minigames/KnifeThrow.js?v=tumblekin89";
import { TowerStack } from "./minigames/TowerStack.js?v=tumblekin89";
import { CliffClimb } from "./minigames/CliffClimb.js?v=tumblekin89";
import { BalloonGlide } from "./minigames/BalloonGlide.js?v=tumblekin89";
import { SumoPush } from "./minigames/SumoPush.js?v=tumblekin89";
import { Trampoline } from "./minigames/Trampoline.js?v=tumblekin89";
import { FalseSignal } from "./minigames/FalseSignal.js?v=tumblekin89";
import { TracePainter } from "./minigames/TracePainter.js?v=tumblekin89";
import { SortBelt } from "./minigames/SortBelt.js?v=tumblekin89";
import { LightSequence } from "./minigames/LightSequence.js?v=tumblekin89";
import { FlashReflex } from "./minigames/FlashReflex.js?v=tumblekin89";
import { PegBoard } from "./minigames/PegBoard.js?v=tumblekin89";
import { IceStock } from "./minigames/IceStock.js?v=tumblekin89";
import { DeepDig } from "./minigames/DeepDig.js?v=tumblekin89";
import { FishDuel } from "./minigames/FishDuel.js?v=tumblekin89";
import { ColorHunt } from "./minigames/ColorHunt.js?v=tumblekin89";
import { Feedback } from "./game/Feedback.js?v=tumblekin89";
