import { BoardGame } from "./game/BoardGame.js?v=tumblekin113";
import { ClientNetwork } from "./network/ClientNetwork.js?v=tumblekin113";
import { UIManager } from "./ui/UIManager.js?v=tumblekin113";
import { BounceArena } from "./minigames/BounceArena.js?v=tumblekin113";
import { RunnerDerby } from "./minigames/RunnerDerby.js?v=tumblekin113";
import { ColorRush } from "./minigames/ColorRush.js?v=tumblekin113";
import { Nervenprobe } from "./minigames/Nervenprobe.js?v=tumblekin113";
import { RedLightGate } from "./minigames/RedLightGate.js?v=tumblekin113";
import { BalloonPump } from "./minigames/BalloonPump.js?v=tumblekin113";
import { BarrelRoll } from "./minigames/BarrelRoll.js?v=tumblekin113";
import { BombPass } from "./minigames/BombPass.js?v=tumblekin113";
import { CoinRain } from "./minigames/CoinRain.js?v=tumblekin113";
import { WhackBlob } from "./minigames/WhackBlob.js?v=tumblekin113";
import { RopeSkip } from "./minigames/RopeSkip.js?v=tumblekin113";
import { CannonFly } from "./minigames/CannonFly.js?v=tumblekin113";
import { KnifeThrow } from "./minigames/KnifeThrow.js?v=tumblekin113";
import { TowerStack } from "./minigames/TowerStack.js?v=tumblekin113";
import { CliffClimb } from "./minigames/CliffClimb.js?v=tumblekin113";
import { BalloonGlide } from "./minigames/BalloonGlide.js?v=tumblekin113";
import { SumoPush } from "./minigames/SumoPush.js?v=tumblekin113";
import { Trampoline } from "./minigames/Trampoline.js?v=tumblekin113";
import { FalseSignal } from "./minigames/FalseSignal.js?v=tumblekin113";
import { TracePainter } from "./minigames/TracePainter.js?v=tumblekin113";
import { SortBelt } from "./minigames/SortBelt.js?v=tumblekin113";
import { SeekGrid } from "./minigames/SeekGrid.js?v=tumblekin113";
import { SwarmCount } from "./minigames/SwarmCount.js?v=tumblekin113";
import { LightSequence } from "./minigames/LightSequence.js?v=tumblekin113";
import { FlashReflex } from "./minigames/FlashReflex.js?v=tumblekin113";
import { PegBoard } from "./minigames/PegBoard.js?v=tumblekin113";
import { IceStock } from "./minigames/IceStock.js?v=tumblekin113";
import { DeepDig } from "./minigames/DeepDig.js?v=tumblekin113";
import { FishDuel } from "./minigames/FishDuel.js?v=tumblekin113";
import { ColorHunt } from "./minigames/ColorHunt.js?v=tumblekin113";
import { Feedback } from "./game/Feedback.js?v=tumblekin113";
