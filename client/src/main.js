import { BoardGame } from "./game/BoardGame.js?v=tumblekin101";
import { ClientNetwork } from "./network/ClientNetwork.js?v=tumblekin101";
import { UIManager } from "./ui/UIManager.js?v=tumblekin101";
import { BounceArena } from "./minigames/BounceArena.js?v=tumblekin101";
import { RunnerDerby } from "./minigames/RunnerDerby.js?v=tumblekin101";
import { ColorRush } from "./minigames/ColorRush.js?v=tumblekin101";
import { Nervenprobe } from "./minigames/Nervenprobe.js?v=tumblekin101";
import { RedLightGate } from "./minigames/RedLightGate.js?v=tumblekin101";
import { BalloonPump } from "./minigames/BalloonPump.js?v=tumblekin101";
import { BarrelRoll } from "./minigames/BarrelRoll.js?v=tumblekin101";
import { BombPass } from "./minigames/BombPass.js?v=tumblekin101";
import { CoinRain } from "./minigames/CoinRain.js?v=tumblekin101";
import { WhackBlob } from "./minigames/WhackBlob.js?v=tumblekin101";
import { RopeSkip } from "./minigames/RopeSkip.js?v=tumblekin101";
import { CannonFly } from "./minigames/CannonFly.js?v=tumblekin101";
import { KnifeThrow } from "./minigames/KnifeThrow.js?v=tumblekin101";
import { TowerStack } from "./minigames/TowerStack.js?v=tumblekin101";
import { CliffClimb } from "./minigames/CliffClimb.js?v=tumblekin101";
import { BalloonGlide } from "./minigames/BalloonGlide.js?v=tumblekin101";
import { SumoPush } from "./minigames/SumoPush.js?v=tumblekin101";
import { Trampoline } from "./minigames/Trampoline.js?v=tumblekin101";
import { FalseSignal } from "./minigames/FalseSignal.js?v=tumblekin101";
import { TracePainter } from "./minigames/TracePainter.js?v=tumblekin101";
import { SortBelt } from "./minigames/SortBelt.js?v=tumblekin101";
import { SeekGrid } from "./minigames/SeekGrid.js?v=tumblekin101";
import { SwarmCount } from "./minigames/SwarmCount.js?v=tumblekin101";
import { LightSequence } from "./minigames/LightSequence.js?v=tumblekin101";
import { FlashReflex } from "./minigames/FlashReflex.js?v=tumblekin101";
import { PegBoard } from "./minigames/PegBoard.js?v=tumblekin101";
import { IceStock } from "./minigames/IceStock.js?v=tumblekin101";
import { DeepDig } from "./minigames/DeepDig.js?v=tumblekin101";
import { FishDuel } from "./minigames/FishDuel.js?v=tumblekin101";
import { ColorHunt } from "./minigames/ColorHunt.js?v=tumblekin101";
import { Feedback } from "./game/Feedback.js?v=tumblekin101";
