import { BoardGame } from "./game/BoardGame.js?v=tumblekin104";
import { ClientNetwork } from "./network/ClientNetwork.js?v=tumblekin104";
import { UIManager } from "./ui/UIManager.js?v=tumblekin104";
import { BounceArena } from "./minigames/BounceArena.js?v=tumblekin104";
import { RunnerDerby } from "./minigames/RunnerDerby.js?v=tumblekin104";
import { ColorRush } from "./minigames/ColorRush.js?v=tumblekin104";
import { Nervenprobe } from "./minigames/Nervenprobe.js?v=tumblekin104";
import { RedLightGate } from "./minigames/RedLightGate.js?v=tumblekin104";
import { BalloonPump } from "./minigames/BalloonPump.js?v=tumblekin104";
import { BarrelRoll } from "./minigames/BarrelRoll.js?v=tumblekin104";
import { BombPass } from "./minigames/BombPass.js?v=tumblekin104";
import { CoinRain } from "./minigames/CoinRain.js?v=tumblekin104";
import { WhackBlob } from "./minigames/WhackBlob.js?v=tumblekin104";
import { RopeSkip } from "./minigames/RopeSkip.js?v=tumblekin104";
import { CannonFly } from "./minigames/CannonFly.js?v=tumblekin104";
import { KnifeThrow } from "./minigames/KnifeThrow.js?v=tumblekin104";
import { TowerStack } from "./minigames/TowerStack.js?v=tumblekin104";
import { CliffClimb } from "./minigames/CliffClimb.js?v=tumblekin104";
import { BalloonGlide } from "./minigames/BalloonGlide.js?v=tumblekin104";
import { SumoPush } from "./minigames/SumoPush.js?v=tumblekin104";
import { Trampoline } from "./minigames/Trampoline.js?v=tumblekin104";
import { FalseSignal } from "./minigames/FalseSignal.js?v=tumblekin104";
import { TracePainter } from "./minigames/TracePainter.js?v=tumblekin104";
import { SortBelt } from "./minigames/SortBelt.js?v=tumblekin104";
import { SeekGrid } from "./minigames/SeekGrid.js?v=tumblekin104";
import { SwarmCount } from "./minigames/SwarmCount.js?v=tumblekin104";
import { LightSequence } from "./minigames/LightSequence.js?v=tumblekin104";
import { FlashReflex } from "./minigames/FlashReflex.js?v=tumblekin104";
import { PegBoard } from "./minigames/PegBoard.js?v=tumblekin104";
import { IceStock } from "./minigames/IceStock.js?v=tumblekin104";
import { DeepDig } from "./minigames/DeepDig.js?v=tumblekin104";
import { FishDuel } from "./minigames/FishDuel.js?v=tumblekin104";
import { ColorHunt } from "./minigames/ColorHunt.js?v=tumblekin104";
import { Feedback } from "./game/Feedback.js?v=tumblekin104";
