import { BoardGame } from "./game/BoardGame.js?v=tumblekin102";
import { ClientNetwork } from "./network/ClientNetwork.js?v=tumblekin102";
import { UIManager } from "./ui/UIManager.js?v=tumblekin102";
import { BounceArena } from "./minigames/BounceArena.js?v=tumblekin102";
import { RunnerDerby } from "./minigames/RunnerDerby.js?v=tumblekin102";
import { ColorRush } from "./minigames/ColorRush.js?v=tumblekin102";
import { Nervenprobe } from "./minigames/Nervenprobe.js?v=tumblekin102";
import { RedLightGate } from "./minigames/RedLightGate.js?v=tumblekin102";
import { BalloonPump } from "./minigames/BalloonPump.js?v=tumblekin102";
import { BarrelRoll } from "./minigames/BarrelRoll.js?v=tumblekin102";
import { BombPass } from "./minigames/BombPass.js?v=tumblekin102";
import { CoinRain } from "./minigames/CoinRain.js?v=tumblekin102";
import { WhackBlob } from "./minigames/WhackBlob.js?v=tumblekin102";
import { RopeSkip } from "./minigames/RopeSkip.js?v=tumblekin102";
import { CannonFly } from "./minigames/CannonFly.js?v=tumblekin102";
import { KnifeThrow } from "./minigames/KnifeThrow.js?v=tumblekin102";
import { TowerStack } from "./minigames/TowerStack.js?v=tumblekin102";
import { CliffClimb } from "./minigames/CliffClimb.js?v=tumblekin102";
import { BalloonGlide } from "./minigames/BalloonGlide.js?v=tumblekin102";
import { SumoPush } from "./minigames/SumoPush.js?v=tumblekin102";
import { Trampoline } from "./minigames/Trampoline.js?v=tumblekin102";
import { FalseSignal } from "./minigames/FalseSignal.js?v=tumblekin102";
import { TracePainter } from "./minigames/TracePainter.js?v=tumblekin102";
import { SortBelt } from "./minigames/SortBelt.js?v=tumblekin102";
import { SeekGrid } from "./minigames/SeekGrid.js?v=tumblekin102";
import { SwarmCount } from "./minigames/SwarmCount.js?v=tumblekin102";
import { LightSequence } from "./minigames/LightSequence.js?v=tumblekin102";
import { FlashReflex } from "./minigames/FlashReflex.js?v=tumblekin102";
import { PegBoard } from "./minigames/PegBoard.js?v=tumblekin102";
import { IceStock } from "./minigames/IceStock.js?v=tumblekin102";
import { DeepDig } from "./minigames/DeepDig.js?v=tumblekin102";
import { FishDuel } from "./minigames/FishDuel.js?v=tumblekin102";
import { ColorHunt } from "./minigames/ColorHunt.js?v=tumblekin102";
import { Feedback } from "./game/Feedback.js?v=tumblekin102";
