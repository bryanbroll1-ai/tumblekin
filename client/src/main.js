import { BoardGame } from "./game/BoardGame.js?v=tumblekin88";
import { ClientNetwork } from "./network/ClientNetwork.js?v=tumblekin88";
import { UIManager } from "./ui/UIManager.js?v=tumblekin88";
import { BounceArena } from "./minigames/BounceArena.js?v=tumblekin88";
import { RunnerDerby } from "./minigames/RunnerDerby.js?v=tumblekin88";
import { ColorRush } from "./minigames/ColorRush.js?v=tumblekin88";
import { Nervenprobe } from "./minigames/Nervenprobe.js?v=tumblekin88";
import { RedLightGate } from "./minigames/RedLightGate.js?v=tumblekin88";
import { BalloonPump } from "./minigames/BalloonPump.js?v=tumblekin88";
import { BarrelRoll } from "./minigames/BarrelRoll.js?v=tumblekin88";
import { BombPass } from "./minigames/BombPass.js?v=tumblekin88";
import { CoinRain } from "./minigames/CoinRain.js?v=tumblekin88";
import { WhackBlob } from "./minigames/WhackBlob.js?v=tumblekin88";
import { RopeSkip } from "./minigames/RopeSkip.js?v=tumblekin88";
import { CannonFly } from "./minigames/CannonFly.js?v=tumblekin88";
import { KnifeThrow } from "./minigames/KnifeThrow.js?v=tumblekin88";
import { TowerStack } from "./minigames/TowerStack.js?v=tumblekin88";
import { CliffClimb } from "./minigames/CliffClimb.js?v=tumblekin88";
import { BalloonGlide } from "./minigames/BalloonGlide.js?v=tumblekin88";
import { SumoPush } from "./minigames/SumoPush.js?v=tumblekin88";
import { Trampoline } from "./minigames/Trampoline.js?v=tumblekin88";
import { FalseSignal } from "./minigames/FalseSignal.js?v=tumblekin88";
import { TracePainter } from "./minigames/TracePainter.js?v=tumblekin88";
import { SortBelt } from "./minigames/SortBelt.js?v=tumblekin88";
import { LightSequence } from "./minigames/LightSequence.js?v=tumblekin88";
import { FlashReflex } from "./minigames/FlashReflex.js?v=tumblekin88";
import { PegBoard } from "./minigames/PegBoard.js?v=tumblekin88";
import { IceStock } from "./minigames/IceStock.js?v=tumblekin88";
import { DeepDig } from "./minigames/DeepDig.js?v=tumblekin88";
import { FishDuel } from "./minigames/FishDuel.js?v=tumblekin88";
import { ColorHunt } from "./minigames/ColorHunt.js?v=tumblekin88";
import { Feedback } from "./game/Feedback.js?v=tumblekin88";
