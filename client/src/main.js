import { BoardGame } from "./game/BoardGame.js?v=tumblekin115";
import { ClientNetwork } from "./network/ClientNetwork.js?v=tumblekin115";
import { UIManager } from "./ui/UIManager.js?v=tumblekin115";
import { BounceArena } from "./minigames/BounceArena.js?v=tumblekin115";
import { RunnerDerby } from "./minigames/RunnerDerby.js?v=tumblekin115";
import { ColorRush } from "./minigames/ColorRush.js?v=tumblekin115";
import { Nervenprobe } from "./minigames/Nervenprobe.js?v=tumblekin115";
import { RedLightGate } from "./minigames/RedLightGate.js?v=tumblekin115";
import { BalloonPump } from "./minigames/BalloonPump.js?v=tumblekin115";
import { BarrelRoll } from "./minigames/BarrelRoll.js?v=tumblekin115";
import { BombPass } from "./minigames/BombPass.js?v=tumblekin115";
import { CoinRain } from "./minigames/CoinRain.js?v=tumblekin115";
import { WhackBlob } from "./minigames/WhackBlob.js?v=tumblekin115";
import { RopeSkip } from "./minigames/RopeSkip.js?v=tumblekin115";
import { CannonFly } from "./minigames/CannonFly.js?v=tumblekin115";
import { KnifeThrow } from "./minigames/KnifeThrow.js?v=tumblekin115";
import { TowerStack } from "./minigames/TowerStack.js?v=tumblekin115";
import { CliffClimb } from "./minigames/CliffClimb.js?v=tumblekin115";
import { BalloonGlide } from "./minigames/BalloonGlide.js?v=tumblekin115";
import { SumoPush } from "./minigames/SumoPush.js?v=tumblekin115";
import { Trampoline } from "./minigames/Trampoline.js?v=tumblekin115";
import { FalseSignal } from "./minigames/FalseSignal.js?v=tumblekin115";
import { TracePainter } from "./minigames/TracePainter.js?v=tumblekin115";
import { SortBelt } from "./minigames/SortBelt.js?v=tumblekin115";
import { SeekGrid } from "./minigames/SeekGrid.js?v=tumblekin115";
import { SwarmCount } from "./minigames/SwarmCount.js?v=tumblekin115";
import { LightSequence } from "./minigames/LightSequence.js?v=tumblekin115";
import { FlashReflex } from "./minigames/FlashReflex.js?v=tumblekin115";
import { PegBoard } from "./minigames/PegBoard.js?v=tumblekin115";
import { IceStock } from "./minigames/IceStock.js?v=tumblekin115";
import { DeepDig } from "./minigames/DeepDig.js?v=tumblekin115";
import { FishDuel } from "./minigames/FishDuel.js?v=tumblekin115";
import { ColorHunt } from "./minigames/ColorHunt.js?v=tumblekin115";
import { Feedback } from "./game/Feedback.js?v=tumblekin115";
