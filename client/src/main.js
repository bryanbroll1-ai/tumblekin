import { BoardGame } from "./game/BoardGame.js?v=tumblekin116";
import { ClientNetwork } from "./network/ClientNetwork.js?v=tumblekin116";
import { UIManager } from "./ui/UIManager.js?v=tumblekin116";
import { BounceArena } from "./minigames/BounceArena.js?v=tumblekin116";
import { RunnerDerby } from "./minigames/RunnerDerby.js?v=tumblekin116";
import { ColorRush } from "./minigames/ColorRush.js?v=tumblekin116";
import { Nervenprobe } from "./minigames/Nervenprobe.js?v=tumblekin116";
import { RedLightGate } from "./minigames/RedLightGate.js?v=tumblekin116";
import { BalloonPump } from "./minigames/BalloonPump.js?v=tumblekin116";
import { BarrelRoll } from "./minigames/BarrelRoll.js?v=tumblekin116";
import { BombPass } from "./minigames/BombPass.js?v=tumblekin116";
import { CoinRain } from "./minigames/CoinRain.js?v=tumblekin116";
import { WhackBlob } from "./minigames/WhackBlob.js?v=tumblekin116";
import { RopeSkip } from "./minigames/RopeSkip.js?v=tumblekin116";
import { CannonFly } from "./minigames/CannonFly.js?v=tumblekin116";
import { KnifeThrow } from "./minigames/KnifeThrow.js?v=tumblekin116";
import { TowerStack } from "./minigames/TowerStack.js?v=tumblekin116";
import { CliffClimb } from "./minigames/CliffClimb.js?v=tumblekin116";
import { BalloonGlide } from "./minigames/BalloonGlide.js?v=tumblekin116";
import { SumoPush } from "./minigames/SumoPush.js?v=tumblekin116";
import { Trampoline } from "./minigames/Trampoline.js?v=tumblekin116";
import { FalseSignal } from "./minigames/FalseSignal.js?v=tumblekin116";
import { TracePainter } from "./minigames/TracePainter.js?v=tumblekin116";
import { SortBelt } from "./minigames/SortBelt.js?v=tumblekin116";
import { SeekGrid } from "./minigames/SeekGrid.js?v=tumblekin116";
import { SwarmCount } from "./minigames/SwarmCount.js?v=tumblekin116";
import { LightSequence } from "./minigames/LightSequence.js?v=tumblekin116";
import { FlashReflex } from "./minigames/FlashReflex.js?v=tumblekin116";
import { PegBoard } from "./minigames/PegBoard.js?v=tumblekin116";
import { IceStock } from "./minigames/IceStock.js?v=tumblekin116";
import { DeepDig } from "./minigames/DeepDig.js?v=tumblekin116";
import { FishDuel } from "./minigames/FishDuel.js?v=tumblekin116";
import { ColorHunt } from "./minigames/ColorHunt.js?v=tumblekin116";
import { Feedback } from "./game/Feedback.js?v=tumblekin116";
