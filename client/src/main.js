import { BoardGame } from "./game/BoardGame.js?v=tumblekin117";
import { ClientNetwork } from "./network/ClientNetwork.js?v=tumblekin117";
import { UIManager } from "./ui/UIManager.js?v=tumblekin117";
import { BounceArena } from "./minigames/BounceArena.js?v=tumblekin117";
import { RunnerDerby } from "./minigames/RunnerDerby.js?v=tumblekin117";
import { ColorRush } from "./minigames/ColorRush.js?v=tumblekin117";
import { Nervenprobe } from "./minigames/Nervenprobe.js?v=tumblekin117";
import { RedLightGate } from "./minigames/RedLightGate.js?v=tumblekin117";
import { BalloonPump } from "./minigames/BalloonPump.js?v=tumblekin117";
import { BarrelRoll } from "./minigames/BarrelRoll.js?v=tumblekin117";
import { BombPass } from "./minigames/BombPass.js?v=tumblekin117";
import { CoinRain } from "./minigames/CoinRain.js?v=tumblekin117";
import { WhackBlob } from "./minigames/WhackBlob.js?v=tumblekin117";
import { RopeSkip } from "./minigames/RopeSkip.js?v=tumblekin117";
import { CannonFly } from "./minigames/CannonFly.js?v=tumblekin117";
import { KnifeThrow } from "./minigames/KnifeThrow.js?v=tumblekin117";
import { TowerStack } from "./minigames/TowerStack.js?v=tumblekin117";
import { CliffClimb } from "./minigames/CliffClimb.js?v=tumblekin117";
import { BalloonGlide } from "./minigames/BalloonGlide.js?v=tumblekin117";
import { SumoPush } from "./minigames/SumoPush.js?v=tumblekin117";
import { Trampoline } from "./minigames/Trampoline.js?v=tumblekin117";
import { FalseSignal } from "./minigames/FalseSignal.js?v=tumblekin117";
import { TracePainter } from "./minigames/TracePainter.js?v=tumblekin117";
import { SortBelt } from "./minigames/SortBelt.js?v=tumblekin117";
import { SeekGrid } from "./minigames/SeekGrid.js?v=tumblekin117";
import { SwarmCount } from "./minigames/SwarmCount.js?v=tumblekin117";
import { LightSequence } from "./minigames/LightSequence.js?v=tumblekin117";
import { FlashReflex } from "./minigames/FlashReflex.js?v=tumblekin117";
import { PegBoard } from "./minigames/PegBoard.js?v=tumblekin117";
import { IceStock } from "./minigames/IceStock.js?v=tumblekin117";
import { DeepDig } from "./minigames/DeepDig.js?v=tumblekin117";
import { FishDuel } from "./minigames/FishDuel.js?v=tumblekin117";
import { ColorHunt } from "./minigames/ColorHunt.js?v=tumblekin117";
import { Feedback } from "./game/Feedback.js?v=tumblekin117";
