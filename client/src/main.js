import { BoardGame } from "./game/BoardGame.js?v=tumblekin121";
import { ClientNetwork } from "./network/ClientNetwork.js?v=tumblekin121";
import { UIManager } from "./ui/UIManager.js?v=tumblekin121";
import { BounceArena } from "./minigames/BounceArena.js?v=tumblekin121";
import { RunnerDerby } from "./minigames/RunnerDerby.js?v=tumblekin121";
import { ColorRush } from "./minigames/ColorRush.js?v=tumblekin121";
import { Nervenprobe } from "./minigames/Nervenprobe.js?v=tumblekin121";
import { RedLightGate } from "./minigames/RedLightGate.js?v=tumblekin121";
import { BalloonPump } from "./minigames/BalloonPump.js?v=tumblekin121";
import { BarrelRoll } from "./minigames/BarrelRoll.js?v=tumblekin121";
import { BombPass } from "./minigames/BombPass.js?v=tumblekin121";
import { CoinRain } from "./minigames/CoinRain.js?v=tumblekin121";
import { WhackBlob } from "./minigames/WhackBlob.js?v=tumblekin121";
import { RopeSkip } from "./minigames/RopeSkip.js?v=tumblekin121";
import { CannonFly } from "./minigames/CannonFly.js?v=tumblekin121";
import { KnifeThrow } from "./minigames/KnifeThrow.js?v=tumblekin121";
import { TowerStack } from "./minigames/TowerStack.js?v=tumblekin121";
import { CliffClimb } from "./minigames/CliffClimb.js?v=tumblekin121";
import { BalloonGlide } from "./minigames/BalloonGlide.js?v=tumblekin121";
import { SumoPush } from "./minigames/SumoPush.js?v=tumblekin121";
import { Trampoline } from "./minigames/Trampoline.js?v=tumblekin121";
import { FalseSignal } from "./minigames/FalseSignal.js?v=tumblekin121";
import { TracePainter } from "./minigames/TracePainter.js?v=tumblekin121";
import { SortBelt } from "./minigames/SortBelt.js?v=tumblekin121";
import { SeekGrid } from "./minigames/SeekGrid.js?v=tumblekin121";
import { SwarmCount } from "./minigames/SwarmCount.js?v=tumblekin121";
import { LightSequence } from "./minigames/LightSequence.js?v=tumblekin121";
import { FlashReflex } from "./minigames/FlashReflex.js?v=tumblekin121";
import { PegBoard } from "./minigames/PegBoard.js?v=tumblekin121";
import { IceStock } from "./minigames/IceStock.js?v=tumblekin121";
import { DeepDig } from "./minigames/DeepDig.js?v=tumblekin121";
import { FishDuel } from "./minigames/FishDuel.js?v=tumblekin121";
import { ColorHunt } from "./minigames/ColorHunt.js?v=tumblekin121";
import { Feedback } from "./game/Feedback.js?v=tumblekin121";
