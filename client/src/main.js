import { BoardGame } from "./game/BoardGame.js?v=tumblekin90";
import { ClientNetwork } from "./network/ClientNetwork.js?v=tumblekin90";
import { UIManager } from "./ui/UIManager.js?v=tumblekin90";
import { BounceArena } from "./minigames/BounceArena.js?v=tumblekin90";
import { RunnerDerby } from "./minigames/RunnerDerby.js?v=tumblekin90";
import { ColorRush } from "./minigames/ColorRush.js?v=tumblekin90";
import { Nervenprobe } from "./minigames/Nervenprobe.js?v=tumblekin90";
import { RedLightGate } from "./minigames/RedLightGate.js?v=tumblekin90";
import { BalloonPump } from "./minigames/BalloonPump.js?v=tumblekin90";
import { BarrelRoll } from "./minigames/BarrelRoll.js?v=tumblekin90";
import { BombPass } from "./minigames/BombPass.js?v=tumblekin90";
import { CoinRain } from "./minigames/CoinRain.js?v=tumblekin90";
import { WhackBlob } from "./minigames/WhackBlob.js?v=tumblekin90";
import { RopeSkip } from "./minigames/RopeSkip.js?v=tumblekin90";
import { CannonFly } from "./minigames/CannonFly.js?v=tumblekin90";
import { KnifeThrow } from "./minigames/KnifeThrow.js?v=tumblekin90";
import { TowerStack } from "./minigames/TowerStack.js?v=tumblekin90";
import { CliffClimb } from "./minigames/CliffClimb.js?v=tumblekin90";
import { BalloonGlide } from "./minigames/BalloonGlide.js?v=tumblekin90";
import { SumoPush } from "./minigames/SumoPush.js?v=tumblekin90";
import { Trampoline } from "./minigames/Trampoline.js?v=tumblekin90";
import { FalseSignal } from "./minigames/FalseSignal.js?v=tumblekin90";
import { TracePainter } from "./minigames/TracePainter.js?v=tumblekin90";
import { SortBelt } from "./minigames/SortBelt.js?v=tumblekin90";
import { LightSequence } from "./minigames/LightSequence.js?v=tumblekin90";
import { FlashReflex } from "./minigames/FlashReflex.js?v=tumblekin90";
import { PegBoard } from "./minigames/PegBoard.js?v=tumblekin90";
import { IceStock } from "./minigames/IceStock.js?v=tumblekin90";
import { DeepDig } from "./minigames/DeepDig.js?v=tumblekin90";
import { FishDuel } from "./minigames/FishDuel.js?v=tumblekin90";
import { ColorHunt } from "./minigames/ColorHunt.js?v=tumblekin90";
import { Feedback } from "./game/Feedback.js?v=tumblekin90";
