import { BoardGame } from "./game/BoardGame.js?v=tumblekin122";
import { ClientNetwork } from "./network/ClientNetwork.js?v=tumblekin122";
import { UIManager } from "./ui/UIManager.js?v=tumblekin122";
import { BounceArena } from "./minigames/BounceArena.js?v=tumblekin122";
import { RunnerDerby } from "./minigames/RunnerDerby.js?v=tumblekin122";
import { ColorRush } from "./minigames/ColorRush.js?v=tumblekin122";
import { Nervenprobe } from "./minigames/Nervenprobe.js?v=tumblekin122";
import { RedLightGate } from "./minigames/RedLightGate.js?v=tumblekin122";
import { BalloonPump } from "./minigames/BalloonPump.js?v=tumblekin122";
import { BarrelRoll } from "./minigames/BarrelRoll.js?v=tumblekin122";
import { BombPass } from "./minigames/BombPass.js?v=tumblekin122";
import { CoinRain } from "./minigames/CoinRain.js?v=tumblekin122";
import { WhackBlob } from "./minigames/WhackBlob.js?v=tumblekin122";
import { RopeSkip } from "./minigames/RopeSkip.js?v=tumblekin122";
import { CannonFly } from "./minigames/CannonFly.js?v=tumblekin122";
import { KnifeThrow } from "./minigames/KnifeThrow.js?v=tumblekin122";
import { TowerStack } from "./minigames/TowerStack.js?v=tumblekin122";
import { CliffClimb } from "./minigames/CliffClimb.js?v=tumblekin122";
import { BalloonGlide } from "./minigames/BalloonGlide.js?v=tumblekin122";
import { SumoPush } from "./minigames/SumoPush.js?v=tumblekin122";
import { Trampoline } from "./minigames/Trampoline.js?v=tumblekin122";
import { FalseSignal } from "./minigames/FalseSignal.js?v=tumblekin122";
import { TracePainter } from "./minigames/TracePainter.js?v=tumblekin122";
import { SortBelt } from "./minigames/SortBelt.js?v=tumblekin122";
import { SeekGrid } from "./minigames/SeekGrid.js?v=tumblekin122";
import { SwarmCount } from "./minigames/SwarmCount.js?v=tumblekin122";
import { LightSequence } from "./minigames/LightSequence.js?v=tumblekin122";
import { FlashReflex } from "./minigames/FlashReflex.js?v=tumblekin122";
import { PegBoard } from "./minigames/PegBoard.js?v=tumblekin122";
import { IceStock } from "./minigames/IceStock.js?v=tumblekin122";
import { DeepDig } from "./minigames/DeepDig.js?v=tumblekin122";
import { FishDuel } from "./minigames/FishDuel.js?v=tumblekin122";
import { ColorHunt } from "./minigames/ColorHunt.js?v=tumblekin122";
import { Feedback } from "./game/Feedback.js?v=tumblekin122";
