import { BoardGame } from "./game/BoardGame.js?v=tumblekin120";
import { ClientNetwork } from "./network/ClientNetwork.js?v=tumblekin120";
import { UIManager } from "./ui/UIManager.js?v=tumblekin120";
import { BounceArena } from "./minigames/BounceArena.js?v=tumblekin120";
import { RunnerDerby } from "./minigames/RunnerDerby.js?v=tumblekin120";
import { ColorRush } from "./minigames/ColorRush.js?v=tumblekin120";
import { Nervenprobe } from "./minigames/Nervenprobe.js?v=tumblekin120";
import { RedLightGate } from "./minigames/RedLightGate.js?v=tumblekin120";
import { BalloonPump } from "./minigames/BalloonPump.js?v=tumblekin120";
import { BarrelRoll } from "./minigames/BarrelRoll.js?v=tumblekin120";
import { BombPass } from "./minigames/BombPass.js?v=tumblekin120";
import { CoinRain } from "./minigames/CoinRain.js?v=tumblekin120";
import { WhackBlob } from "./minigames/WhackBlob.js?v=tumblekin120";
import { RopeSkip } from "./minigames/RopeSkip.js?v=tumblekin120";
import { CannonFly } from "./minigames/CannonFly.js?v=tumblekin120";
import { KnifeThrow } from "./minigames/KnifeThrow.js?v=tumblekin120";
import { TowerStack } from "./minigames/TowerStack.js?v=tumblekin120";
import { CliffClimb } from "./minigames/CliffClimb.js?v=tumblekin120";
import { BalloonGlide } from "./minigames/BalloonGlide.js?v=tumblekin120";
import { SumoPush } from "./minigames/SumoPush.js?v=tumblekin120";
import { Trampoline } from "./minigames/Trampoline.js?v=tumblekin120";
import { FalseSignal } from "./minigames/FalseSignal.js?v=tumblekin120";
import { TracePainter } from "./minigames/TracePainter.js?v=tumblekin120";
import { SortBelt } from "./minigames/SortBelt.js?v=tumblekin120";
import { SeekGrid } from "./minigames/SeekGrid.js?v=tumblekin120";
import { SwarmCount } from "./minigames/SwarmCount.js?v=tumblekin120";
import { LightSequence } from "./minigames/LightSequence.js?v=tumblekin120";
import { FlashReflex } from "./minigames/FlashReflex.js?v=tumblekin120";
import { PegBoard } from "./minigames/PegBoard.js?v=tumblekin120";
import { IceStock } from "./minigames/IceStock.js?v=tumblekin120";
import { DeepDig } from "./minigames/DeepDig.js?v=tumblekin120";
import { FishDuel } from "./minigames/FishDuel.js?v=tumblekin120";
import { ColorHunt } from "./minigames/ColorHunt.js?v=tumblekin120";
import { Feedback } from "./game/Feedback.js?v=tumblekin120";
