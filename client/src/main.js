import { BoardGame } from "./game/BoardGame.js?v=tumblekin79";
import { ClientNetwork } from "./network/ClientNetwork.js?v=tumblekin79";
import { UIManager } from "./ui/UIManager.js?v=tumblekin79";
import { BounceArena } from "./minigames/BounceArena.js?v=tumblekin79";
import { RunnerDerby } from "./minigames/RunnerDerby.js?v=tumblekin79";
import { ColorRush } from "./minigames/ColorRush.js?v=tumblekin79";
import { Nervenprobe } from "./minigames/Nervenprobe.js?v=tumblekin79";
import { RedLightGate } from "./minigames/RedLightGate.js?v=tumblekin79";
import { BalloonPump } from "./minigames/BalloonPump.js?v=tumblekin79";
import { BarrelRoll } from "./minigames/BarrelRoll.js?v=tumblekin79";
import { BombPass } from "./minigames/BombPass.js?v=tumblekin79";
import { CoinRain } from "./minigames/CoinRain.js?v=tumblekin79";
import { WhackBlob } from "./minigames/WhackBlob.js?v=tumblekin79";
import { RopeSkip } from "./minigames/RopeSkip.js?v=tumblekin79";
import { CannonFly } from "./minigames/CannonFly.js?v=tumblekin79";
import { KnifeThrow } from "./minigames/KnifeThrow.js?v=tumblekin79";
import { TowerStack } from "./minigames/TowerStack.js?v=tumblekin79";
import { CliffClimb } from "./minigames/CliffClimb.js?v=tumblekin79";
import { SlingShot } from "./minigames/SlingShot.js?v=tumblekin79";
import { SumoPush } from "./minigames/SumoPush.js?v=tumblekin79";
import { Trampoline } from "./minigames/Trampoline.js?v=tumblekin79";
import { FalseSignal } from "./minigames/FalseSignal.js?v=tumblekin79";
import { TracePainter } from "./minigames/TracePainter.js?v=tumblekin79";
import { PlateSpin } from "./minigames/PlateSpin.js?v=tumblekin79";
import { FishDuel } from "./minigames/FishDuel.js?v=tumblekin79";
import { ColorHunt } from "./minigames/ColorHunt.js?v=tumblekin79";
import { Feedback } from "./game/Feedback.js?v=tumblekin79";
