import { BoardGame } from "./game/BoardGame.js?v=tumblekin111";
import { ClientNetwork } from "./network/ClientNetwork.js?v=tumblekin111";
import { UIManager } from "./ui/UIManager.js?v=tumblekin111";
import { BounceArena } from "./minigames/BounceArena.js?v=tumblekin111";
import { RunnerDerby } from "./minigames/RunnerDerby.js?v=tumblekin111";
import { ColorRush } from "./minigames/ColorRush.js?v=tumblekin111";
import { Nervenprobe } from "./minigames/Nervenprobe.js?v=tumblekin111";
import { RedLightGate } from "./minigames/RedLightGate.js?v=tumblekin111";
import { BalloonPump } from "./minigames/BalloonPump.js?v=tumblekin111";
import { BarrelRoll } from "./minigames/BarrelRoll.js?v=tumblekin111";
import { BombPass } from "./minigames/BombPass.js?v=tumblekin111";
import { CoinRain } from "./minigames/CoinRain.js?v=tumblekin111";
import { WhackBlob } from "./minigames/WhackBlob.js?v=tumblekin111";
import { RopeSkip } from "./minigames/RopeSkip.js?v=tumblekin111";
import { CannonFly } from "./minigames/CannonFly.js?v=tumblekin111";
import { KnifeThrow } from "./minigames/KnifeThrow.js?v=tumblekin111";
import { TowerStack } from "./minigames/TowerStack.js?v=tumblekin111";
import { CliffClimb } from "./minigames/CliffClimb.js?v=tumblekin111";
import { BalloonGlide } from "./minigames/BalloonGlide.js?v=tumblekin111";
import { SumoPush } from "./minigames/SumoPush.js?v=tumblekin111";
import { Trampoline } from "./minigames/Trampoline.js?v=tumblekin111";
import { FalseSignal } from "./minigames/FalseSignal.js?v=tumblekin111";
import { TracePainter } from "./minigames/TracePainter.js?v=tumblekin111";
import { SortBelt } from "./minigames/SortBelt.js?v=tumblekin111";
import { SeekGrid } from "./minigames/SeekGrid.js?v=tumblekin111";
import { SwarmCount } from "./minigames/SwarmCount.js?v=tumblekin111";
import { LightSequence } from "./minigames/LightSequence.js?v=tumblekin111";
import { FlashReflex } from "./minigames/FlashReflex.js?v=tumblekin111";
import { PegBoard } from "./minigames/PegBoard.js?v=tumblekin111";
import { IceStock } from "./minigames/IceStock.js?v=tumblekin111";
import { DeepDig } from "./minigames/DeepDig.js?v=tumblekin111";
import { FishDuel } from "./minigames/FishDuel.js?v=tumblekin111";
import { ColorHunt } from "./minigames/ColorHunt.js?v=tumblekin111";
import { Feedback } from "./game/Feedback.js?v=tumblekin111";
