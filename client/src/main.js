import { BoardGame } from "./game/BoardGame.js?v=tumblekin65";
import { ClientNetwork } from "./network/ClientNetwork.js?v=tumblekin65";
import { UIManager } from "./ui/UIManager.js?v=tumblekin65";
import { BounceArena } from "./minigames/BounceArena.js?v=tumblekin65";
import { RunnerDerby } from "./minigames/RunnerDerby.js?v=tumblekin65";
import { ColorRush } from "./minigames/ColorRush.js?v=tumblekin65";
import { Nervenprobe } from "./minigames/Nervenprobe.js?v=tumblekin65";
import { RedLightGate } from "./minigames/RedLightGate.js?v=tumblekin65";
import { BalloonPump } from "./minigames/BalloonPump.js?v=tumblekin65";
import { BarrelRoll } from "./minigames/BarrelRoll.js?v=tumblekin65";
import { BombPass } from "./minigames/BombPass.js?v=tumblekin65";
import { CoinRain } from "./minigames/CoinRain.js?v=tumblekin65";
import { WhackBlob } from "./minigames/WhackBlob.js?v=tumblekin65";
import { RopeSkip } from "./minigames/RopeSkip.js?v=tumblekin65";
import { CannonFly } from "./minigames/CannonFly.js?v=tumblekin65";
import { KnifeThrow } from "./minigames/KnifeThrow.js?v=tumblekin65";
import { TowerStack } from "./minigames/TowerStack.js?v=tumblekin65";
import { CliffClimb } from "./minigames/CliffClimb.js?v=tumblekin65";
import { Feedback } from "./game/Feedback.js?v=tumblekin65";
