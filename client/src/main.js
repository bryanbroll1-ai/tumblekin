import { BoardGame } from "./game/BoardGame.js?v=tumblekin91";
import { ClientNetwork } from "./network/ClientNetwork.js?v=tumblekin91";
import { UIManager } from "./ui/UIManager.js?v=tumblekin91";
import { BounceArena } from "./minigames/BounceArena.js?v=tumblekin91";
import { RunnerDerby } from "./minigames/RunnerDerby.js?v=tumblekin91";
import { ColorRush } from "./minigames/ColorRush.js?v=tumblekin91";
import { Nervenprobe } from "./minigames/Nervenprobe.js?v=tumblekin91";
import { RedLightGate } from "./minigames/RedLightGate.js?v=tumblekin91";
import { BalloonPump } from "./minigames/BalloonPump.js?v=tumblekin91";
import { BarrelRoll } from "./minigames/BarrelRoll.js?v=tumblekin91";
import { BombPass } from "./minigames/BombPass.js?v=tumblekin91";
import { CoinRain } from "./minigames/CoinRain.js?v=tumblekin91";
import { WhackBlob } from "./minigames/WhackBlob.js?v=tumblekin91";
import { RopeSkip } from "./minigames/RopeSkip.js?v=tumblekin91";
import { CannonFly } from "./minigames/CannonFly.js?v=tumblekin91";
import { KnifeThrow } from "./minigames/KnifeThrow.js?v=tumblekin91";
import { TowerStack } from "./minigames/TowerStack.js?v=tumblekin91";
import { CliffClimb } from "./minigames/CliffClimb.js?v=tumblekin91";
import { BalloonGlide } from "./minigames/BalloonGlide.js?v=tumblekin91";
import { SumoPush } from "./minigames/SumoPush.js?v=tumblekin91";
import { Trampoline } from "./minigames/Trampoline.js?v=tumblekin91";
import { FalseSignal } from "./minigames/FalseSignal.js?v=tumblekin91";
import { TracePainter } from "./minigames/TracePainter.js?v=tumblekin91";
import { SortBelt } from "./minigames/SortBelt.js?v=tumblekin91";
import { LightSequence } from "./minigames/LightSequence.js?v=tumblekin91";
import { FlashReflex } from "./minigames/FlashReflex.js?v=tumblekin91";
import { PegBoard } from "./minigames/PegBoard.js?v=tumblekin91";
import { IceStock } from "./minigames/IceStock.js?v=tumblekin91";
import { DeepDig } from "./minigames/DeepDig.js?v=tumblekin91";
import { FishDuel } from "./minigames/FishDuel.js?v=tumblekin91";
import { ColorHunt } from "./minigames/ColorHunt.js?v=tumblekin91";
import { Feedback } from "./game/Feedback.js?v=tumblekin91";
