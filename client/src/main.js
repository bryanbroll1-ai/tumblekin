import { BoardGame } from "./game/BoardGame.js?v=tumblekin103";
import { ClientNetwork } from "./network/ClientNetwork.js?v=tumblekin103";
import { UIManager } from "./ui/UIManager.js?v=tumblekin103";
import { BounceArena } from "./minigames/BounceArena.js?v=tumblekin103";
import { RunnerDerby } from "./minigames/RunnerDerby.js?v=tumblekin103";
import { ColorRush } from "./minigames/ColorRush.js?v=tumblekin103";
import { Nervenprobe } from "./minigames/Nervenprobe.js?v=tumblekin103";
import { RedLightGate } from "./minigames/RedLightGate.js?v=tumblekin103";
import { BalloonPump } from "./minigames/BalloonPump.js?v=tumblekin103";
import { BarrelRoll } from "./minigames/BarrelRoll.js?v=tumblekin103";
import { BombPass } from "./minigames/BombPass.js?v=tumblekin103";
import { CoinRain } from "./minigames/CoinRain.js?v=tumblekin103";
import { WhackBlob } from "./minigames/WhackBlob.js?v=tumblekin103";
import { RopeSkip } from "./minigames/RopeSkip.js?v=tumblekin103";
import { CannonFly } from "./minigames/CannonFly.js?v=tumblekin103";
import { KnifeThrow } from "./minigames/KnifeThrow.js?v=tumblekin103";
import { TowerStack } from "./minigames/TowerStack.js?v=tumblekin103";
import { CliffClimb } from "./minigames/CliffClimb.js?v=tumblekin103";
import { BalloonGlide } from "./minigames/BalloonGlide.js?v=tumblekin103";
import { SumoPush } from "./minigames/SumoPush.js?v=tumblekin103";
import { Trampoline } from "./minigames/Trampoline.js?v=tumblekin103";
import { FalseSignal } from "./minigames/FalseSignal.js?v=tumblekin103";
import { TracePainter } from "./minigames/TracePainter.js?v=tumblekin103";
import { SortBelt } from "./minigames/SortBelt.js?v=tumblekin103";
import { SeekGrid } from "./minigames/SeekGrid.js?v=tumblekin103";
import { SwarmCount } from "./minigames/SwarmCount.js?v=tumblekin103";
import { LightSequence } from "./minigames/LightSequence.js?v=tumblekin103";
import { FlashReflex } from "./minigames/FlashReflex.js?v=tumblekin103";
import { PegBoard } from "./minigames/PegBoard.js?v=tumblekin103";
import { IceStock } from "./minigames/IceStock.js?v=tumblekin103";
import { DeepDig } from "./minigames/DeepDig.js?v=tumblekin103";
import { FishDuel } from "./minigames/FishDuel.js?v=tumblekin103";
import { ColorHunt } from "./minigames/ColorHunt.js?v=tumblekin103";
import { Feedback } from "./game/Feedback.js?v=tumblekin103";
