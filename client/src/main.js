import { BoardGame } from "./game/BoardGame.js?v=tumblekin110";
import { ClientNetwork } from "./network/ClientNetwork.js?v=tumblekin110";
import { UIManager } from "./ui/UIManager.js?v=tumblekin110";
import { BounceArena } from "./minigames/BounceArena.js?v=tumblekin110";
import { RunnerDerby } from "./minigames/RunnerDerby.js?v=tumblekin110";
import { ColorRush } from "./minigames/ColorRush.js?v=tumblekin110";
import { Nervenprobe } from "./minigames/Nervenprobe.js?v=tumblekin110";
import { RedLightGate } from "./minigames/RedLightGate.js?v=tumblekin110";
import { BalloonPump } from "./minigames/BalloonPump.js?v=tumblekin110";
import { BarrelRoll } from "./minigames/BarrelRoll.js?v=tumblekin110";
import { BombPass } from "./minigames/BombPass.js?v=tumblekin110";
import { CoinRain } from "./minigames/CoinRain.js?v=tumblekin110";
import { WhackBlob } from "./minigames/WhackBlob.js?v=tumblekin110";
import { RopeSkip } from "./minigames/RopeSkip.js?v=tumblekin110";
import { CannonFly } from "./minigames/CannonFly.js?v=tumblekin110";
import { KnifeThrow } from "./minigames/KnifeThrow.js?v=tumblekin110";
import { TowerStack } from "./minigames/TowerStack.js?v=tumblekin110";
import { CliffClimb } from "./minigames/CliffClimb.js?v=tumblekin110";
import { BalloonGlide } from "./minigames/BalloonGlide.js?v=tumblekin110";
import { SumoPush } from "./minigames/SumoPush.js?v=tumblekin110";
import { Trampoline } from "./minigames/Trampoline.js?v=tumblekin110";
import { FalseSignal } from "./minigames/FalseSignal.js?v=tumblekin110";
import { TracePainter } from "./minigames/TracePainter.js?v=tumblekin110";
import { SortBelt } from "./minigames/SortBelt.js?v=tumblekin110";
import { SeekGrid } from "./minigames/SeekGrid.js?v=tumblekin110";
import { SwarmCount } from "./minigames/SwarmCount.js?v=tumblekin110";
import { LightSequence } from "./minigames/LightSequence.js?v=tumblekin110";
import { FlashReflex } from "./minigames/FlashReflex.js?v=tumblekin110";
import { PegBoard } from "./minigames/PegBoard.js?v=tumblekin110";
import { IceStock } from "./minigames/IceStock.js?v=tumblekin110";
import { DeepDig } from "./minigames/DeepDig.js?v=tumblekin110";
import { FishDuel } from "./minigames/FishDuel.js?v=tumblekin110";
import { ColorHunt } from "./minigames/ColorHunt.js?v=tumblekin110";
import { Feedback } from "./game/Feedback.js?v=tumblekin110";
