...
import {
  ...
  createShadowBlob,
  createVoxelKin
} from "../minigames/VoxelKit.js?v=tumblekin124";
import { ENVIRONMENT_SETS, OBSTACLE_TYPES, createEnvironment, createObstacle } from "./EnvironmentKit.js?v=tumblekin124";
