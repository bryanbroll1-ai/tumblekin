...
import {
  ...
  createShadowBlob,
  createVoxelKin
} from "../minigames/VoxelKit.js?v=tumblekin113";
import { ENVIRONMENT_SETS, OBSTACLE_TYPES, createEnvironment, createObstacle } from "./EnvironmentKit.js?v=tumblekin113";
