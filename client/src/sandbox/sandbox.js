...
import {
  ...
  createShadowBlob,
  createVoxelKin
} from "../minigames/VoxelKit.js?v=tumblekin112";
import { ENVIRONMENT_SETS, OBSTACLE_TYPES, createEnvironment, createObstacle } from "./EnvironmentKit.js?v=tumblekin112";
