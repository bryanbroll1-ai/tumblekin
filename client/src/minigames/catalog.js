...
export const MINIGAME_CATALOG = [
  ...
  { type: "ballonPump", title: "Pump-Panik", family: "pump", gesture: "tap", help: "Tippen pumpt deinen Ballon auf — kurz warten bindet ihn zu, dann fliegt er davon und seine Luft zählt. Aber jeder Ballon hat eine Grenze: wird er rot, zittert und quietscht, wird es eng. Pumpst du zu weit, platzt er und die Luft ist weg. Knapp vor der Grenze zugebunden gibt es einen Mut-Bonus." },
