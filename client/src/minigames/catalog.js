export const GESTURES = {
  ...
  alternate: { icon: "👈👉", label: "Links/rechts im Wechsel" },
...
export const MINIGAME_CATALOG = [
  ...
  { type: "ballonPump", title: "Pump-Panik", family: "pump", gesture: "alternate", help: "Drück die beiden Pumpknöpfe abwechselnd — links, rechts, links … so schnell du kannst. Nur der Wechsel pumpt, zweimal dieselbe Seite bewegt den Kolben nicht. Der dickste Ballon gewinnt." },
  ...
  { type: "tiefenrausch", title: "Tiefenrausch", family: "dive", gesture: "greed", help: "Tippen gräbt eine Stufe tiefer und bringt Gold — aber jeder Stollen kann einstürzen, und dann ist alles weg, was noch unten hängt. Das Risiko der nächsten Stufe steht genau im Bild. Wisch nach oben, um deine Beute sicher einzuzahlen — was bei Rundenende noch unten hängt, verfällt." },
  { type: "farbenjagd", title: "Farbenjagd", family: "paint", gesture: "joystick", help: "Schieb deine Farbwalze mit dem Stick über die Leinwand — was sie überrollt, hat sofort deine Farbe, auch fremde. Fahr eine Schleife zurück in deine Farbe: alles, was du damit einkreist, wird auf einen Schlag deins. Goldene Walze = breiter malen, Farbbombe = großer Klecks. Wer am Ende die meiste Fläche hat, gewinnt." },
