...
```bash
npm run smoke                # alle 22 Minispiele
...
- Three.js rendert die drei datengetriebenen Spielwelten, vier animierte Figuren und alle 22 Challenges.
